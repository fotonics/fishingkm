...
<div id="navigation" class="sticky">
  <nav class="top-bar" role="navigation" data-topbar>
    <ul class="title-area">
      <li class="name">
      <h1 class="show-for-small-only"><a href="http://localhost:4000" class="icon-tree"> FishingKm</a></h1>
    </li>
...
<div id="masthead-no-image-header">
	<div class="row">
		<div class="small-12 columns">
			<a id="logo" href="http://localhost:4000/" title="FishingKm – Рыбалка на Канале имени Москвы">
				<img src="http://localhost:4000/assets/img/logo.png" alt="FishingKm – Рыбалка на Канале имени Москвы">
			</a>
        ...
        <div class="row">
          <div class="medium-6 large-5 columns">
            ...
            <p class="shadow-black">
              ...
              <a href="http://localhost:4000/info/">Открыть ›</a>
            </p>
          </div><!-- /.large-6.columns -->
